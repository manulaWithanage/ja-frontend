...
// 30s timeout — JSearch normally responds in 5–8s; this covers slow retries.
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Build backend URL — append bypass_cache when set
    ...
    // If streaming, pipe the SSE stream as-is
    ...
    return NextResponse.json(
      {
        error: isTimeout ? "Search timed out — please try again" : "Failed to search jobs",
