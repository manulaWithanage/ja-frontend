...
export default function Header() {
  ...
  const handleLogout = async () => {
    ...
    setTimeout(() => {
      window.location.href = "/hr-portal/login";
    }, 500);
  };
    ...
    <header className="border-b border-white/5 bg-black/20 backdrop-blur-md sticky top-0 z-20">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2">
          <a href="/hr-portal" className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-3 text-xs text-zinc-400">
          ...
          {/* Auth Buttons (Hidden on HR Portal as it's now public) */}
