    ...
    <aside className="flex h-screen w-64 shrink-0 flex-col border-r border-zinc-800/60 bg-zinc-950">
      ...
      <div className="border-t border-zinc-800/60 px-4 py-4 space-y-2">
        <div className="flex items-center gap-3 rounded-xl bg-zinc-900/60 px-3 py-2.5">
          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-violet-500/20 text-[11px] font-bold text-violet-300">
            JA
          </div>
          <div className="min-w-0 flex-1">
            <p className="text-xs font-semibold text-zinc-200 truncate">JA Admin</p>
            <p className="text-[10px] text-zinc-500 truncate">admin@jateam.com</p>
          </div>
        </div>
        <button
